...
- **[dist-job-processor](https://github.com/rnavxn/dist-job-processor)** — Distributed job queue with fault tolerance, circuit breakers, and idempotent retries. Built with Spring Boot, Redis, and PostgreSQL.
...
**Backend:** Java, Spring Boot, PostgreSQL, Docker, Redis  
...
- DSA (trees, linked lists, DP, graphs) — placement prep
